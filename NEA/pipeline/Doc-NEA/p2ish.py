...
SCREENS = {
    ...
    'help_menu_1': {
        ...
        'help_text': 'This is help page 1. It has very useful information and I will add more later, thank you very much and have a good day.'
    },
    'help_menu_2': {
        'title': 'Help Menu - Page 2',
        'navbtn': {'text': 'Back', 'target': 'main_menu'},
        'help_text': 'This is help page 2. More helpful information will go here!'
    },
    'input_menu': {
        'title': 'Input Menu',
        'navbtn': {'text': 'Back', 'target': 'main_menu'},
        'buttons': {
            1: {'pos': (640, 260), 'text': '', 'size': INP_BTN_SIZE, 'input': True},
            2: {'pos': (640, 360), 'text': '', 'size': INP_BTN_SIZE, 'input': True},
            3: {'pos': (640, 460), 'text': '', 'size': INP_BTN_SIZE, 'input': True},
            'clear': {'pos': (640, 560), 'text': 'Clear All', 'size': INP_BTN_SIZE},
            'start': {'pos': (640, 650), 'text': 'Start', 'target': 'start_menu', 'size': INP_BTN_SIZE}
        }
    },
    'start_menu': {
        'title': 'Start Menu'
...
def renderscreen(screen, font, activebtn, current_screen, screen_data):
    ...
    # Draw title
    title_surf = font.render(screen_info['title'], True, COLOURS['title'])
...
def main():
    ...
    for screenid, screen_info in SCREENS.items():
        ...
        if 'buttons' in screen_info:
            screen_data[screenid]['buttons'] = {k: v.copy() for k, v in screen_info['buttons'].items()}
